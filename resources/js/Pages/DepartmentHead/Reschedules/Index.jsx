...
export default function Index({ pendingReschedules = [], approvedReschedules = [], department }) {
    ...
    const renderDates = (dateArray, requestId, type) => {
        if (!dateArray || dateArray.length === 0) return <span className="text-sm text-gray-500">—</span>;
            ...
            <div className="flex flex-col">
                ...
                {hasMore && (
                    <button
                        ...
                        className="text-xs text-[#FF2D20] hover:underline mt-0.5 self-start"
                    >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                            <svg className="size-6 text-[#FF2D20]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <nav className="-mb-px flex space-x-8">
                        ...
                        >
                            ...
                            <span className={`ml-2 py-0.5 px-2 rounded-full text-xs ${
                                activeTab === 'pending' ? 'bg-[#FF2D20]/10 text-[#FF2D20]' : 'bg-gray-100 text-gray-500'
                            }`}>
                                {totalPending}
                            </span>
                        </button>
                        ...
                        >
                            Approved
                            <span className={`ml-2 py-0.5 px-2 rounded-full text-xs ${
                                activeTab === 'approved' ? 'bg-[#FF2D20]/10 text-[#FF2D20]' : 'bg-gray-100 text-gray-500'
                            }`}>
                                {totalApproved}
                            </span>
                        </button>
                            ...
                            <table className="w-full text-sm text-left text-gray-700">
                                <thead className="bg-gray-50 text-xs uppercase text-gray-500">
                                    <tr>
                                        ...
                                        <th className="px-3 py-2">Original Dates</th>
                                        <th className="px-3 py-2">New Dates</th>
                                    ...
                                    {currentData.map((res) => {
                                        ...
                                        return (
                                            <tr key={res.id} className="hover:bg-gray-50 transition">
                                                ...
                                                <td className="px-3 py-2 text-sm">{leaveTypeName}</td>
                                                ...
                                                <td className="px-3 py-2 text-right">
                                                    <Link
                                                        ...
                                                        className="text-[#FF2D20] hover:underline font-medium text-sm"
                                                    >
