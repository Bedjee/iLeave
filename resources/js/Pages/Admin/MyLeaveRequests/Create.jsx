...
// Validation hook (same as Employee)
function useLeaveValidation(
    ...
    useEffect(() => {
        ...
        // ... all the same validation rules as in Employee Create ...
        // (I'm omitting the full body for brevity, but it's identical)
        // You should copy the entire useEffect content from the Employee Create file.
...
export default function Create({ leaveTypes, balances, employee, hasTakenMaternityLeave, hasTakenAdoptionLeave, vlBalance, slBalance }) {
        ...
        <AdminLayout>
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <p className="text-sm text-gray-500 mt-1">{employee?.name || 'Employee'} · {employee?.position || ''} · {employee?.department || ''}</p>
