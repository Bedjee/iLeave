...
export default function Edit({ department, employees }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        skip_department_head_approval: department.skip_department_head_approval || false,
    });
        ...
        <HRMOLayout>
            ...
            <div className="space-y-6 max-w-3xl mx-auto">
                <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold" style={{ color: NAVY }}>Edit Department</h2>
                </div>
