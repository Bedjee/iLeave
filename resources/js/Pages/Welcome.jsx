    ...
    const features = [
        {
            ...
            description: 'Submit leave requests in seconds with our intuitive interface. No paperwork, no hassle.',
            icon: (
        ...
        },
        {
            ...
            description: 'Your data is protected with enterprise-grade security. SSL encryption, regular backups, and strict access controls.',
            icon: (
        ...
        },
        {
            ...
            description: 'Follow every step of your leave application. Get instant notifications when your request moves forward.',
            icon: (
    ...
    return (
        <>
            <Head title="iLeave — Integrated Leave Management System">
                ...
                <link
                    href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Plus+Jakarta+Sans:ital,wght@0,500;0,600;0,700;0,800;1,500&display=swap"
                    rel="stylesheet"
                />
            </Head>

            <div className="min-h-screen bg-white antialiased flex flex-col" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
                ...
                <header className="relative z-30 border-b border-black/5 flex-shrink-0">
                    <div className="max-w-7xl mx-auto px-6 lg:px-10 py-3 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            />
                            <div className="border-l pl-4" style={{ borderColor: 'rgba(15,42,82,0.14)' }}>
                                <p className="text-[15px] sm:text-base font-bold tracking-tight" style={{ color: NAVY, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                        ...
                        {auth.user ? (
                            <Link
                                ...
                                className="text-sm font-medium px-4 py-2 rounded-md border transition hover:bg-[#0F2A52]/5"
                                style={{ color: NAVY, borderColor: 'rgba(15,42,82,0.25)' }}
                            >
                                Go to dashboard
                            </Link>
                        ) : (
                            <span className="hidden sm:block text-[11px] uppercase tracking-[0.14em] text-gray-400">
                ...
                <section className="relative flex-1 flex flex-col justify-center overflow-visible">
                    {/* Decorative curve */}
                    <div className="absolute bottom-0 left-0 w-full h-[200px] pointer-events-none z-0">
                        <svg
                        ...
                        >
                            ...
                            <path
                                d="M0,200 C200,200 900,20 1440,20 L1440,200 Z"
                                fill={NAVY}
                            />
                            <path
                                d="M0,200 C200,200 900,20 1440,20"
                                fill="none"
                    ...
                    <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 py-6 md:py-10 w-full grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-10 lg:gap-8 items-center">
                        {/* Left content */}
                        <div className={`max-w-xl transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                            <span className="inline-block text-xs font-semibold uppercase tracking-[0.16em]" style={{ color: GOLD }}>
                                Welcome to
                            </span>

                            <h1
                                className="mt-2 text-[48px] sm:text-[60px] lg:text-[72px] font-extrabold leading-[0.92] tracking-tight"
                                style={{ color: NAVY, fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                            >
                                <span style={{ color: GOLD }}>i</span>Leave
                            </h1>

                            <p className="mt-3 text-lg sm:text-xl text-gray-500" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 500 }}>
                                Integrated Leave Management System
                            </p>

                            <p className="mt-4 text-[15px] leading-relaxed text-gray-600 max-w-md">
                            ...
                            <div className="mt-6 bg-[#FAFAF9] rounded-xl p-4 border border-gray-200/60 overflow-hidden min-h-[72px]">
                                    ...
                                    {features.map((_, i) => (
                                        <button
                                            ...
                                            className={`h-1 rounded-full transition-all duration-300 ${
                                                i === activeFeature ? 'w-4' : 'w-1.5'
                                            }`}
                                            style={{
                                                backgroundColor: i === activeFeature ? GOLD : '#D1D5DB',
                                            }}
                            ...
                            <div className="mt-6 flex flex-wrap items-center gap-6 text-sm">
                                <div className="flex items-center space-x-2">
                                    <div className="w-8 h-8 rounded-full bg-[#FEF3C7] flex items-center justify-center text-[#0032A0]">
                        ...
                        {/* Sign-in card */}
                        <div className={`relative w-full max-w-md mx-auto lg:mx-0 lg:justify-self-end z-20 transition-all duration-700 delay-200 ${
                            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                        }`}>
                            <div className="rounded-xl bg-white shadow-[0_20px_60px_-15px_rgba(15,42,82,0.25)] border overflow-hidden" style={{ borderColor: 'rgba(15,42,82,0.10)' }}>
                                <div className="h-1" style={{ backgroundColor: GOLD }} />

                                <div className="px-8 pt-8 pb-6 text-center border-b" style={{ borderColor: 'rgba(15,42,82,0.08)', backgroundColor: '#FAFAF9' }}>
                                    <img
                                        src="/images/opol.png"
                                        alt="Official seal of the Municipality of Opol"
                                        className="h-20 w-20 object-contain mx-auto"
                                    />
                                    <h2 className="mt-4 text-xl font-bold" style={{ color: NAVY, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                                ...
                                <form onSubmit={submit} className="px-8 py-6 space-y-4" noValidate>
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full rounded-lg border ${errors.email ? 'border-red-500' : 'border-gray-300'} pl-10 pr-3 py-2.5 text-sm focus:outline-none focus:ring-2 transition`}
                                                style={{ '--tw-ring-color': 'rgba(15,42,82,0.25)' }}
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full rounded-lg border ${errors.password ? 'border-red-500' : 'border-gray-300'} pl-10 pr-10 py-2.5 text-sm focus:outline-none focus:ring-2 transition`}
                                                placeholder="••••••••"
                                                required
                                    ...
                                    <button
                                        type="submit"
                                        disabled={processing}
                                        className="w-full py-3 rounded-lg text-white text-sm font-semibold tracking-wide shadow-sm hover:shadow-md transition disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group"
                                ...
                                <p className="pb-6 text-center text-[11px] uppercase tracking-[0.12em] text-gray-400">
                                    Official use only
                                </p>
                            </div>
                        </div>
                ...
                <section className="relative overflow-hidden flex-shrink-0" style={{ backgroundColor: NAVY }}>
                    {/* Decorative rings */}
                    <div
                        className="pointer-events-none select-none absolute -left-24 -bottom-24 w-[420px] h-[420px] rounded-full opacity-[0.06]"
                        style={{ border: `1.5px solid ${GOLD}` }}
                        aria-hidden="true"
                    />
                    <div
                        className="pointer-events-none select-none absolute -left-8 -bottom-8 w-[300px] h-[300px] rounded-full opacity-[0.06]"
                        style={{ border: `1.5px solid ${GOLD}` }}
                        aria-hidden="true"
                    />
                    <div
                        className="pointer-events-none select-none absolute -right-20 -top-20 w-[200px] h-[200px] rounded-full opacity-[0.04]"
                        style={{ border: `1.5px solid ${GOLD}` }}
                        aria-hidden="true"
                    />

                    <div className="relative max-w-7xl mx-auto px-6 lg:px-10 py-8 md:py-10 grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-6 items-center">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {values.map((v, i) => (
                                ...
                                >
                                    <svg className="w-6 h-6 mb-3 group-hover:scale-110 transition-transform duration-300" fill="none" stroke={GOLD} viewBox="0 0 24 24">
                                        {v.icon}
                                    </svg>
                                    <h4 className="text-white text-[15px] font-semibold" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                                        {v.title}
                                    </h4>
                        ...
                        <div className="lg:border-l lg:pl-10 text-left lg:text-right" style={{ borderColor: 'rgba(198,162,77,0.25)' }}>
                            <p
                                className="text-xl md:text-2xl text-white/90 leading-snug"
                ...
                >
                    <div className="max-w-7xl mx-auto px-6 lg:px-10 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-xs text-white/45">
                        ...
                        <p>
                            ...
                            <span className="hidden sm:inline text-white/25"> · Laravel v{laravelVersion} · PHP v{phpVersion}</span>
                        </p>
                    </div>
                </footer>
            </div>
